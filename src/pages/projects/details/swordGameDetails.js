...
const pageText = (
    <>
        ...
        <p>All the physics, movement, and combat mechanics were done from scratch.  This project used some free art assets and animations I found online; I did draw the little target dummy myself though.</p>

        <p>Posture has a lot of moving parts so it might be a little hard to tell exactly what's going on just from watching.  You can try it yourself, or here's an in-depth explanation of the mechanic:</p>
