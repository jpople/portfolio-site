      ...
      <Container className="App-header flex-fill align-items-center justify-content-center">
        <Col className="col-6 justify-content-center">
          <div className="mt-4 p-4 rounded" style={{backgroundColor: "rgba(10, 10, 10, 0.7)"}}>
            ...
            <p>
              I made this site!  This and some other (arguably more interesting) things I've made are over in <a href="/projects">[projects]</a> where you can look at them, try them out, and read some of my thoughts about them.
            </p>
          </div>
        </Col>
      </Container>
